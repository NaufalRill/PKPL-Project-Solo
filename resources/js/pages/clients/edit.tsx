...
import { BreadcrumbItem, Client, User } from '@/types';
...
export default function EditClientForm({ client, user }: EditFormProps) {
    ...
    return (
        <MainLayout breadcrumbs={breadcrumbs} title={t('app.edit_client')}>
            <Head title={t('app.edit_client')} />
            <form onSubmit={submit} className="mt-12 space-y-8">
                ...
                <div className="grid grid-cols-1 gap-x-8 gap-y-4 md:grid-cols-2">
                    ...
                    <Label htmlFor="password">
                        {t('app.client_password')} (<span className="text-sm text-muted-foreground">{t('app.client_password_empty')}</span>)
                    </Label>
                    <div>
                        <Input
                            id="email"
                    ...
                    <div className="grid gap-6">
                        <Input
                            ...
                            placeholder={t('app.client_password_placeholder_edit')}
                        />
